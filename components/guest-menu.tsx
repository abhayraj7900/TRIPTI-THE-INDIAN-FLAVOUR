    ...
    <main className="min-h-screen bg-[#f7f1e8] text-[#251a15]">
      <header className="sticky top-0 z-40 border-b border-[#eadfd3] bg-[#fffaf4]/95 backdrop-blur">
        <div className="mx-auto flex h-18 max-w-7xl items-center justify-between px-4 sm:px-6">
          <button aria-label="Tripti home" onClick={() => { window.location.href = '/menu'; }} className="flex items-center text-left">
            {/* oxlint-disable-next-line next/no-img-element */}
            <img src="/tripti-logo.png" alt="" className="h-12 w-32 object-contain drop-shadow-sm sm:w-36" />
          </button>
