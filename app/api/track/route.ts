...
export async function GET(request: Request) {
  try {
    ...
    return Response.json(
      {
        error: error instanceof Error ? error.message : 'Unable to track order',
      },
      { status: 500 },
    );
  }
